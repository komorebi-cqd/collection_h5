<template>
	<view class="collection-bg">
	    <view class="collection" :class="{'collection-video-wrap': !isImg}">
	          <view class="collection-border" :class="{'collection-video': !isImg}">
					<!-- <view class="media-wrap">
                        <image class="details-img" :src="url" mode="aspectFill" v-if="isImg"></image>
                        <video id="video" class="details-video" :show-center-play-btn="false" :autoplay="true" muted :src="url" objectFit="contain" v-else></video>
                    </view> -->
